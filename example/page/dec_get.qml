    ...
    Item
    {
        ...
        ScrollView   ///输入框
        {
            ...
            FluMultilineTextBox
            {
                ...
                id:textbox_code
                focus:true
                placeholderText: "your email IAMP 授权码\n【链接服务器时间可能较长，请耐心等待，若程序出现卡顿，说明邮箱第三方服务器网络波动】\n\n\n\n\n\n"
            }
        ...
        {
            id:button_send
            text:controller.isLoading ? timer_loading.loadingText :"收取"
            anchors
            {
                bottom: parent.bottom
                right: parent.right
           ...
           // disabled: controller.isLoading
            onClicked://点击的作用
            {
              ...
              //  appendMessage(true,text)//给这个txt做了什么处理？
                controller.emailget("none",text_code)//发送给谁这个文本
                showSuccess("收取成功")
                showSuccess("解密成功")
                showSuccess("认证成功")
