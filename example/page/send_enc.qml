...
*/
    ...
    Item
    {
        ...
        ScrollView   ///message输入框
        {
            id:scrollview
            anchors{
               top: parent.top
                bottom:scrollview4.top
                left: parent.left
        ...
        ScrollView   ///我的KEY输入框
        {
            ...
            FluMultilineTextBox
            {
                ...
                id:m_key
                focus:true
                placeholderText: "your email key （SMTP授权码）"
            }
        ...
        ScrollView   ///对方ID输入框
        {
            ...
            FluMultilineTextBox
            {
                ...
                id:textbox
                focus:true
                placeholderText: "reciver's email address"
            }
        ...
        FluFilledButton//按钮的操作
        {
            ...
            onClicked://点击的作用
            {
              ...
              //  appendMessage(true,text)//给这个txt做了什么处理？
                controller.sendMessage(text,text_code,"enc")//只生成不发生，调用复用函数
        ...
        FluFilledButton//按钮的操作
        {
            ...
            onClicked://点击的作用
            {
                ...
                else
                {
                    ...
                    var key=m_key.text
              //  appendMessage(true,text)//给这个txt做了什么处理？
                controller.sendemail(text_code,text,key)//发送给谁这个文本
                 //(const QString& message,const QString& address,const QString& key)
               // textbox.clear()//发送完清空文本
                }
            }
         }
